...
const InvoicesPage: React.FC = () => {
  ...
  return (
    <DashboardLayout requireAdmin={true}>
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-cafeBlack">Factures</h1>
          ...
          <table className="w-full table-auto">
            <thead>
              <tr className="border-b border-gray-200">
                <th className="pb-3 text-left font-semibold text-cafeBlack">ID</th>
                ...
                <th className="pb-3 text-left font-semibold text-cafeBlack">Articles</th>
                <th className="pb-3 text-left font-semibold text-cafeBlack">Total</th>
                <th className="pb-3 text-right font-semibold text-cafeBlack">Action</th>
              </tr>
            </thead>
            <tbody>
              {orders.length === 0 ? (
                ...
                orders.map((order) => (
                  <tr key={order.id} className="border-b border-gray-100 last:border-0">
                    ...
                    <td className="py-3">{new Date(order.date).toLocaleString()}</td>
